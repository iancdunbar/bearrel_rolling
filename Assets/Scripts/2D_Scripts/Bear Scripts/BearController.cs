...
public class BearController : MonoBehaviour {
	...
	private static string[] deathMessages = { "DEATH IS UPON YOU, BEAR", "DEAD TIME RAVE", "NO HAPPINESS", "THE DARK CLOSES IN", "THERE IS NO HAPPY HERE", "THIS IS UNBEARABLE", "YOU BEARLY DIED THAT TIME", "DEATH IS HARD TO BEAR" };	
